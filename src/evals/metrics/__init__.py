...
from evals.metrics.bioun import (
    fa_score,
    def_score,
    ewef_score,
    ocd_score,
...
# Register BioUnlearn metrics (see evals/metrics/bioun.py)
_register_metric(fa_score)
_register_metric(def_score)
_register_metric(ewef_score)
_register_metric(ocd_score)
